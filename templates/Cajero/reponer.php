  ...
  <div class="col s6 push-s3">
    <div class="card">
        ...
        <div class="card-content">
          ...
          <div class=" input-field col inline s12">
            <span>
              <strong>Disponibles en pasillo: </strong>
              <?php
                echo $total;
              ?>
            </span>
            <br>
            <span>
                <strong>Disponibles en Almacen</strong>
                <?php
                    echo $almacen;
                ?>
            </span>
          </div>
          <?= $this->Form->button(__('Reponer') , array('class'=> 'waves-effect yellow accent-2 btn-large black-text')) ?>
          <?= $this->Form->end() ?>
        </div>
