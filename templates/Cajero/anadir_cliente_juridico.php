...
<div class="row">
    <div class="col s4 offset-s1" id="panelMadera2">
        <h4 class="white-text center">Registrar Cliente Juridico</h4>
        <?= $this->Form->create($personaJuridica, array('class' =>'col s8 offset-s2 white')) ?>
        ...
        <div class="section">
            ...
            <?= $this->Html->link(__('¿Eres persona Natural? Registrate Aqui'), [ 'action' =>'anadirCliente']);?>
        <?= $this->Form->end() ?>
    </div>
