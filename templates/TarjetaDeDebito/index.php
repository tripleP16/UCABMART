 ...
 * @var \App\Model\Entity\TarjetaDeDebito[]|\Cake\Collection\CollectionInterface $tarjetaDeDebito
 */
?>
<div class="row ">
        ...
        <table id="tiendas" class="responsive-table centered highlight" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= h($query['tar_deb_titular']) ?></td>
                    <td><?= h($query['tar_deb_fecha_emision']) ?></td>
                    <td><?= h($query['tar_deb_cvv']) ?></td>
                    <td><?= h($query['tar_deb_tipo_cuenta']) ?></td>
                    <td><?= h($query['tar_deb_tipo']) ?></td>
                    <td class="actions">
